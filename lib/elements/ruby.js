...
(function () {
    ...
    ruby.newSegmentAndCategoriseRubyElement = function (el) {
        ...
        ,   makeAnnotationSegment = function (range, baseTextSegment) {
                return {
                    el:                 el
                ,   baseTextSegment:    baseTextSegment || null
                };
            }
        ,   makeRTCSegment = function (el, baseTextSegments) {
                return {
                    el:                 el
        ...
        var processRubyChild = function () {
            ...
            if (helpers.isElementCalled(currentChild, "rb")) {
                ...
                baseRange.setStart(root, index);
                baseRange.setEnd(root, index + 1);
